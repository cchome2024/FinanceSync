...
## 5. 快速验证功能
1. 在“数据录入”对话窗口输入：“导入 2025/11/03 账户余额：至明 127200.39，资产 2296463.78，喀戎 94429.60。”
2. 确认系统返回候选记录 → 点击“确认写入”。
3. 输入：“上传本月收入表格”，选择样例 `revenue.xlsx` → 检查预览与警告。
4. 切换到“查询分析”对话窗口，发送问题：“对比上季度收入和本季度预测” → 查看占位回答与高亮提示。
5. 打开“财务看板”页面，选择“最新数据”与历史月份，确认图表刷新在 3 秒内完成。
